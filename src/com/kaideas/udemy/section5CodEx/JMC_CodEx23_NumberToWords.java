...
public class JMC_CodEx23_NumberToWords {
  ...
  public static void main(String[] args) {
    ...
    //
    System.out.println(0 + " has " + getDigitCount(0) + " digits"); //should return 1 since there is only 1 digit
    //
    System.out.println(123 + " has " + getDigitCount(123) + " digits"); //should return 3
    //
    System.out.println(-12 + " has " + getDigitCount(-12) + " digits"); //should return -1 since the parameter is negative
    //
    System.out.println(5200 + " has " + getDigitCount(5200) + " digits"); //should return 4 since there are 4 digits in the number

    System.out.println("\n\nExample Input/Output - reverse method");
    //
    System.out.println(-121 + " reversed is: " + reverse(-121)); // should  return -121
    //
    System.out.println(1212 + " reversed is: " + reverse(1212)); //should return  2121
    //
    System.out.println(1234 + " reversed is: " + reverse(1234)); //should return 4321
    //
    System.out.println(100 + " reversed is: " + reverse(100)); // should return 1
  ...
  public static void numberToWords(int number){
    ...
    //System.out.println("reversed count: " + reversedCount);

    do {
        int printNumber = reversed % 10;
      ...
      for(int i = numberCount - reversedCount;i > 0; i--)
        System.out.print("Zero ");
