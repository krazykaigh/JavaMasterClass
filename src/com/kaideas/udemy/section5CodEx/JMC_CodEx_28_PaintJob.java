...
public class JMC_CodEx_28_PaintJob {

  public static void main(String[] args) {

    System.out.println(getBucketCount(-3.4, 2.1, 1.5, 2)); // return -1
    ...
    System.out.println(getBucketCount(-3.4, 2.1, 1.5)); // return -1
    System.out.println(getBucketCount(6.26, 2.2)); // return 3
...
// of paint he needs to buy before going to work. Bob might also have some extra buckets at home.
...
//
//
//NOTE: Use the method Math.ceil to round the number of calculated buckets (double) then convert it into an int
