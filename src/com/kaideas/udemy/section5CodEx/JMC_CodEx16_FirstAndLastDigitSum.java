...
public class JMC_CodEx16_FirstAndLastDigitSum {
...
//
//* sumFirstAndLastDigit(0); → should return 10, the first digit and the last digit is 5 since we only have 1 digit,
